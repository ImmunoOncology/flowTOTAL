...
#' simplified_kept_file <- simplify_flowCore(filename = "path/to/input.fcs", keep = c("FSC-A", "SSC-A"))
#' }
#'
#' @export
...
#' @examples
#' \dontrun{
#' doPreprocessing(file = "path/to/input.fcs", filename = "preprocessed_input.fcs", output = "output_directory")
#' }
#'
#' @export
